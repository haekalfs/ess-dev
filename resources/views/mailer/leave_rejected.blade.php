...
<p>Your Leave Request has been <span style="color: red;"><i>Rejected</i></span> by {{ $leaveRequest->user->name }}. Please note that this is final and cannot be contested.</p>
<p>Here are the notes provided: <br>{{ $leaveRequest->notes }}</p>
