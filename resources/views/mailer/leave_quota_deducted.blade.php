...
<br><br>
Number of Joint Holidays: {{ $totalHolidays }}<br>
Leave Quota Deduction: {{ $totalHolidays }} days (equivalent to the number of joint holidays)<br>
We understand that this may affect your personal leave planning. To minimize any inconvenience, please note the following:
<br>
<br>
<p>This deduction only applies to your annual leave quota. Other leave types, such as sick leave or compassionate leave, remain unaffected.</p>
You can still apply for leave using the usual channels, but please be mindful of your revised leave balance.</p>
If you have any questions or concerns regarding this adjustment, please do not hesitate to contact the Human Resources department at hrd@perdana.co.id or admin@perdana.co.id.</p>
We appreciate your understanding and cooperation in this matter. Please continue to plan your leave responsibly and ensure smooth operations within your teams.</p>
<br>
