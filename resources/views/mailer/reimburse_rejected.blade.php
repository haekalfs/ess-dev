...
<p>One of your reimbursement items from Reimbursement No : <span style="font-weight: bold;">{{ $reimbId }}</span> has been Rejected. Kindly request your review for the documents.</p>

<p>Please open this link below :<br><a href="{{ $link }}{{ $reimbId }}"><strong>Click Here</strong></a></p>
<br>
