...
<p>Selamat Menjadi Bagian di Perdana Consulting <b> {{ $userName }} </b>
Berikut link untuk mengakses ESS Untuk pengisian timesheet tiap bulan dan juga kebutuhan lainnya. 
Berikut dilampirkan email dan password yang dapat digunakan.
</p>
<table>
    <tr>
        <td>{{ $emailUser }}</td>
