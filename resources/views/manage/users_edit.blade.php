        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <ul class="nav nav-tabs" id="pageTabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="page3-tab" data-toggle="tab" href="#page3" role="tab" aria-controls="page3" aria-selected="false"><i class="fas fa-university style="color: #ff0000;"></i> Bank Details</a>
                    </li>
                </ul>
                <!-- Card Body -->
                <div class="card-body">
