...
@section('title', 'List Consultant - ESS')

@section('active-page-consultant')
active
@endsection
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h4 class="m-0 font-weight-bold text-primary">List Consultant</h4>
    </div>
    <!-- Card Body -->
    <div class="card-body">
        <table class="table table-bordered table-hover text-center" id="dataTableUser">
            ...
            <tbody>
                @foreach($consultants as $p)
                    @if($p->users_detail->position_id === '4' || $p->users_detail->position_id === '18' || $p->users_detail->position_id ==='19')
                        <tr>
