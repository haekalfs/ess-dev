...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Timesheet Approval <small style="color: red;"><i> &nbsp;&nbsp;Primary</i></small></h1>
...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Timesheet Approval <small style="color: red;"><i> &nbsp;&nbsp;Prior</i></small></h1>
<p class="mb-4">Approval Page.</p>
@if ($message = Session::get('success'))
<div class="alert alert-success alert-block">
    <button type="button" class="close" data-dismiss="alert">×</button>
