...
class Timesheet_detail extends Model
{
    ...
    protected $fillable = ['id', 'ts_task', 'ts_task_id' , 'roleAs', 'allowances', 'workhours','RequestTo', 'ts_location', 'incentive' , 'ts_mandays','user_id','activity','note', 'date_submitted', 'ts_status_id','user_timesheet', 'month_periode','created_at','updated_at'];
