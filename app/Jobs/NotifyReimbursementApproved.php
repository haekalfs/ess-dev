...
class NotifyReimbursementApproved implements ShouldQueue
{
    ...
    {
        $notification = new ReimbursementApproved($this->employee, $this->userName);
        Mail::send('mailer.reimburse_approved', $notification->data(), function ($message) use ($notification) {
