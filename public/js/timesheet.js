                ...
                if (response.length === 0) {
                    ...
                    $.each(response, function(index, activity) {
                        ...
                        var taskElement = $('<span></span>')
                            ...
                            .addClass(roundClass)
                            .html('<i class="text-dark">&nbsp;' + activity.ts_from_time + ' - ' + activity.ts_to_time + '</i><br>' + ' <span> '+ icon +'</span>' + activity.ts_task + '<br><span>&nbsp;&nbsp;&#11177;&nbsp;' + activity.ts_activity + '</span')
                            .attr('data-target', '#updateModal')
                            .attr('data-toggle', 'modal')
                            .attr('data-date', activity.ts_date)
                            .attr('data-id', activity.ts_id);
                        descTask.append(taskElement);
                    });
